...
curl localhost:8080/monkeys/ >> output.txt 2>> error.txt

printf "\n\n\ncommand: GET zoos\n\n" | tee  -a output.txt  error.txt
curl localhost:8080/zoos/ >> output.txt 2>> error.txt

printf "\n\n\ncommand: GET zoo name wacky zachy\n\n" | tee  -a output.txt  error.txt
curl localhost:8080/zoos/Wacky%20Zachy%27s%20Monkey%20Attacky >> output.txt 2>> error.txt


printf "\n\n\ncommand: GET monkey_id 2\n\n" | tee  -a output.txt  error.txt
curl localhost:8080/monkeys/2 >> output.txt 2>> error.txt


printf "\n\n\ncommand: GET zoo via monkey_id 2\n\n" | tee  -a output.txt  error.txt
curl localhost:8080/monkeys/2/zoo >> output.txt 2>> error.txt
...
curl -X DELETE localhost:8080/monkeys/1 >> output.txt 2>> error.txt

printf "\n\n\ncommand delete wacky zachy's\n\n" | tee  -a output.txt  error.txt
curl -X DELETE localhost:8080/zoos/Wacky%20Zachy%27s%20Monkey%20Attacky >> output.txt 2>> error.txt

printf "\n\n\ncommand delete all monkeys\n\n" | tee  -a output.txt  error.txt
curl -X DELETE localhost:8080/monkeys/ >> output.txt 2>> error.txt
...
curl -X DELETE localhost:8080/zoos/ >> output.txt 2>> error.txt
